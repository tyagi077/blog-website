...
blogRouter.get("/pending",authenticate,roleMiddleware(['admin','superadmin']),getPendingBlogs);
blogRouter.get("/create-blog",authenticate,getblogPage);
blogRouter.get('/add-sector',authenticate,roleMiddleware(['admin','superadmin']),getAddSectorPage);
blogRouter.get('/my-blogs',authenticate,myBlogsPage);
blogRouter.get('/allBlogs',authenticate,getAllPublicApprovedBlogs);
blogRouter.get('/approved-blogs', authenticate,roleMiddleware(['admin','superadmin']), getPendingBlogsPage);
blogRouter.post('/approve/:id', authenticate, approveBlog);
blogRouter.get('/blogs/:id',publicBlogMiddleware,getBlogDetails);
